...
/* The description of the baseConversion function is that this */
/*function will take in the user input of the intial base they want, */
/*the number and base they want to convert to, and it will return */
/*the new value  */
	...
	while (num[len] != '\0') {
		...
		if (len == 0) { /*this counts the length of the num*/
	...
	if (baseFrom == baseTo) {/* if both from and to base are same*/
